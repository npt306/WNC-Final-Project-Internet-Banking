...
export class EmployeeController {
  ...
  @ApiResponse({ status: 200, description: 'Return employee by id.', type: Employee })
  @ApiResponse({ status: 403, description: 'Forbidden.' })
  @Get(':id')
  ...
  @ApiResponse({ status: 200, description: 'Return updated employee.', type: Employee })
  @ApiBody({
  ...
  @ApiResponse({ status: 200, description: 'Return deleted employee.', type: Employee })
  @Delete(':id')
